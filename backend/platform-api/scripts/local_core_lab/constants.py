...
CANARY_COMPOSE = PLATFORM_API / "docker-compose.local-telegram-canary.yml"
ENV_EXAMPLE = PLATFORM_API / ".env.local.example"
CANARY_ENV_EXAMPLE = PLATFORM_API / ".env.local.example"
ENSURE_CORE_DB = ROOT / "postgres" / "scripts" / "ensure_local_core_database.py"
ENSURE_CANARY_DB = ROOT / "postgres" / "scripts" / "ensure_local_telegram_canary_database.py"
