...
def test_plan_default_is_offline_and_correct():
    ...
    assert len(payload["would_apply"]) == 35  # +lead_actor_channels_v11 (20.09.2026), +site_request_contacts_v12 (24.09.2026)
...
def test_build_offline_plan_function():
    ...
    assert report.ok
    assert len(report.would_apply) == 35  # +lead_actor_channels_v11 (20.09.2026), +site_request_contacts_v12 (24.09.2026)
