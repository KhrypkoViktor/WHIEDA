...
async def run_structured_query(
    ...
    # These are the small set of bundles explicitly active in the structured
    # runtime.  The larger RAW-derived staging queue is intentionally not read
    # here: approval controls what may reach a person.
