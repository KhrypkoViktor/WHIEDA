...
def discomfort_boundary_text(tenant: TenantContext) -> str:
    ...
    if is_home_tenant(tenant.tenant_id):
        return (
            "Я не ставлю диагноз и не заменяю врача. Могу помочь подобрать товар WHIEDA под вашу задачу: "
    ...
    return (
        "Я не ставлю диагноз и не заменяю врача. Могу помочь подобрать товар под вашу задачу: "
        "домашний прибор, сон и восстановление, уход, энергия или старт."
    )
